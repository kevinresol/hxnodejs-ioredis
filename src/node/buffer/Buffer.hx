...
@:jsRequire("buffer", "Buffer") extern class Buffer {
	...
	**/
	...
	@:overload(function(array:haxe.ds.ReadOnlyArray<Dynamic>):global.Buffer { })
	@:overload(function(buffer:global.Buffer):global.Buffer { })
	function new(str:String, ?encoding:global.BufferEncoding);
	...
	**/
	@:overload(function(data:haxe.ds.ReadOnlyArray<Float>):global.Buffer { })
	@:overload(function(data:js.lib.Uint8Array):global.Buffer { })
	@:overload(function(obj:ts.AnyOf2<{ function valueOf():ts.AnyOf2<String, Dynamic>; }, { }>, ?byteOffset:Float, ?length:Float):global.Buffer { })
	@:overload(function(str:String, ?encoding:global.BufferEncoding):global.Buffer { })
	...
	**/
	static function concat(list:haxe.ds.ReadOnlyArray<js.lib.Uint8Array>, ?totalLength:Float):global.Buffer;
	/**
	...
	**/
	static function alloc(size:Float, ?fill:ts.AnyOf3<String, Float, global.Buffer>, ?encoding:global.BufferEncoding):global.Buffer;
	/**
