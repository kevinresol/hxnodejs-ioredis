...
@:jsRequire("crypto", "Signer") extern class Signer extends node.stream.Writable {
	...
	@:overload(function(private_key:ts.AnyOf5<String, global.Buffer, KeyObject, SignKeyObjectInput, SignPrivateKeyInput>, output_format:HexBase64Latin1Encoding):String { })
