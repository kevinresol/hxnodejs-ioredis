...
@:jsRequire("crypto", "Verify") extern class Verify extends node.stream.Writable {
	...
	@:overload(function(object:ts.AnyOf5<String, global.Buffer, KeyObject, VerifyKeyObjectInput, VerifyPublicKeyInput>, signature:String, ?signature_format:HexBase64Latin1Encoding):Bool { })
