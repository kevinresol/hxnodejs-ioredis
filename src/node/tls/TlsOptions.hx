...
typedef TlsOptions = {
	...
	**/
	@:optional
	var key : ts.AnyOf3<String, global.Buffer, Array<ts.AnyOf2<global.Buffer, KeyObject>>>;
	/**
	...
	**/
	@:optional
	var pfx : ts.AnyOf3<String, global.Buffer, Array<ts.AnyOf3<String, global.Buffer, PxfObject>>>;
	/**
