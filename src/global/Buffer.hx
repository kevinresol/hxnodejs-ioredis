...
@:native("Buffer") extern class Buffer extends js.lib.Uint8Array {
	...
	**/
	@:overload(function(data:haxe.ds.ReadOnlyArray<Float>):Buffer { })
	@:overload(function(data:js.lib.Uint8Array):Buffer { })
	@:overload(function(obj:ts.AnyOf2<{ function valueOf():ts.AnyOf2<String, Dynamic>; }, { }>, ?byteOffset:Float, ?length:Float):Buffer { })
	@:overload(function(str:String, ?encoding:BufferEncoding):Buffer { })
