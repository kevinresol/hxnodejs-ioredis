...
typedef Redis = {
	...
	final status : String;
	function connect(?callback:() -> Void):js.lib.Promise<Void>;
	function disconnect():Void;
	function duplicate():Redis;
	function send_command(command:String, args:haxe.extern.Rest<ValueType_>):js.lib.Promise<Dynamic>;
	function addListener(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Redis;
	function on(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Redis;
	function once(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Redis;
	function removeListener(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Redis;
	function off(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Redis;
	function removeAllListeners(?event:ts.AnyOf2<String, js.lib.Symbol>):Redis;
	function setMaxListeners(n:Float):Redis;
	...
	function prependListener(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Redis;
	function prependOnceListener(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Redis;
